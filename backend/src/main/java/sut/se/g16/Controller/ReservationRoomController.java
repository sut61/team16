...
public class ReservationRoomController{
    ...
    @GetMapping("/reservationroom/{totalPriceReservationRoom}/{datein}/{dateout}/{roomType}/{cus}/{pro}/{hotel}/{roomId}")
    public ReservationRoomEntity ReservationRoom(@PathVariable Double totalPriceReservationRoom,@PathVariable Long roomId, @PathVariable String datein,@PathVariable String dateout,@PathVariable long roomType,@PathVariable Long hotel,@PathVariable String cus, @PathVariable Long pro){
